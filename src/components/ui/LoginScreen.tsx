...
export default function LoginScreen() {
  ...
  return (
    <div className="flex flex-col justify-center h-full px-6 py-8">
      ...
      {/* Campos */}
      <label className="text-[13px] font-medium text-gray-500 dark:text-gray-400 mb-1.5 block">E-mail</label>
      <input
        type="email"
        value={email}
      ...
      <input
        ...
        className="w-full border border-gray-200 dark:border-gray-600 rounded-xl px-4 py-3.5 text-[15px] mb-4 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
      />
